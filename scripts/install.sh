...
echo "  siko send \"analyze this\"   # Queue a daily development task"
echo "  siko tui                  # Open the local task UI"
echo "  siko acp                  # Start the ACP server for external tools"
echo "  siko acp install zed      # Register Sikong in Zed"
echo ""
