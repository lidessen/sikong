...
7. `dogfood.md` - Sikong self-development loop: doc-first tasks, repository analysis, patch tasks, live eval, and daily dogfood gates.
8. `client-agent.md` - UI-embedded Client Agent shape and client work-log boundaries.
9. `client-ui-user-stories.md` - operator-facing client UI stories and interaction hierarchy.
10. `console-ui-generation.md` - compact operations-console visual generation rules.
11. `command-surface.md` - shared command handler layer for CLI and tools.
12. `cli.md` - external-agent-facing CLI contract.
13. `daemon-runtime.md` - Go daemon supervision, Bun child-process concurrency, and runtime process boundaries.
14. `implementation-plan.md` - current phased implementation sequence and module boundaries.
15. Future area docs under this directory for storage details and runtime integration.
