...
5. `client-agent.md` - UI-embedded Client Agent shape and client work-log boundaries.
6. `client-ui-user-stories.md` - operator-facing client UI stories and interaction hierarchy.
7. `console-ui-generation.md` - compact operations-console visual generation rules.
8. `command-surface.md` - shared command handler layer for CLI and tools.
9. `cli.md` - external-agent-facing CLI contract.
10. `daemon-runtime.md` - Go daemon supervision, Bun child-process concurrency, and runtime process boundaries.
11. `implementation-plan.md` - current phased implementation sequence and module boundaries.
12. Future area docs under this directory for storage details and runtime integration.
